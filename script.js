...
function fun() {
    ...
    let object2 = localStorage.getItem("obj2");
    var summary2 = JSON.parse(object2);
    ...
    for (var i = 0; i < summary2.length; i++) {
        year = summary2[i].Date;
       
        if (Number(year.slice(0, 4)) == 2020) {
            year2020Confirmed += summary2[i].Confirmed;
            year2020Deaths += summary2[i].Deaths;
            year2020Recovered += summary2[i].Recovered;
            year2020Active += summary2[i].Active;

        }
        else if (Number(year.slice(0, 4)) == 2021) {
            year2021Confirmed += summary2[i].Confirmed;
            year2021Deaths += summary2[i].Deaths;
            year2021Recovered += summary2[i].Recovered;
            year2021Active += summary2[i].Active;

        }
        else if (Number(year.slice(0, 4)) == 2022) {
            year2022Confirmed += summary2[i].Confirmed;
            year2022Deaths += summary2[i].Deaths;
            year2022Recovered += summary2[i].Recovered;
            year2022Active += summary2[i].Active;

        }
        else if (Number(year.slice(0, 4)) == 2023) {
            year2023Confirmed += summary2[i].Confirmed;
            year2023Deaths += summary2[i].Deaths;
            year2023Recovered += summary2[i].Recovered;
            year2023Active += summary2[i].Active;
    ...
    var TotalConfirmed = year2020Confirmed + year2021Confirmed + year2022Confirmed +year2023Confirmed;
    var TotalDeaths =  year2020Deaths + year2021Deaths + year2022Deaths +year2023Deaths;
    var TotalRecoverd =  year2020Recovered + year2021Recovered + year2022Recovered +year2023Recovered;
    var TotalActive =  year2020Active + year2021Active + year2022Active +year2023Active;

    var cards=document.querySelector("#cards");
    cards.innerHTML = "";

    var card = `<div class="card bg-secondary col-lg shadow-lg"> <h5 style="text-align:center"> Total Confirmed  </h4>   <span style="color:white;text-align:center;font-size:20px"> ${TotalConfirmed}</div>
                <div class="card bg-secondary col-lg shadow-lg"> <h5 style="text-align:center"> Total Deaths  </h4>   <span style="color:white;text-align:center;font-size:20px"> ${TotalDeaths}</div>
                <div class="card bg-secondary col-lg shadow-lg"> <h5 style="text-align:center"> Total Recoverd  </h4>   <span style="color:white;text-align:center;font-size:20px"> ${TotalRecoverd}</div>
                <div class="card bg-secondary col-lg shadow-lg"> <h5 style="text-align:center"> Total Active  </h4>   <span style="color:white;text-align:center;font-size:20px"> ${TotalActive}</div>`
